...
## startsWith
The compared attribute must be a string that starts with the value provided (also a string) to result in a match. 
...
## endsWith
The compared attribute must be a string that ends with the value provided (also a string) to result in a match. 
